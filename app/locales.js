const locales = {
  en_gb: {
    ...
    bereavement_benefit: 'Bereavement Payment',
    ...
    change: 'Change',
    check_bsp: 'Check Bereavement Support Payment',
    check_description: `You've collected details about`,
    check_fep: 'Check Funeral Expenses Payment',
    ...
    disability_living_allowance_child: 'Disability Living Allowance for children',
    disability_living_allowance_working_age: 'Disability Living Allowance for adults under 65',
    ...
    industrial_injury_disablement_benefit: 'Industrial Injury Disablement Benefit',
    ...
    passport: 'Passport',
    page_heading: 'Does the caller want to check if they can get financial support?',
    ...
    select_eligibility: 'Does the caller want to check if they can get financial support?',
