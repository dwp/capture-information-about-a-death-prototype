const locales = {
  en_gb: {
    ...
    building_society_account_question: 'Building society account details',
    ...
    check_description_bsp: 'This will go to the Bereavement Support Payment team.',
    check_description_fep: 'This will go to the Funeral Expenses Payment team.',
    ...
    confirm_send_application: 'Confirm and send',
    consent_message: `The caller agrees that the information they have given is accurate to the best of their knowledge`,
    continue: 'Continue',
    ...
    fep_location: 'Is the funeral being held in the UK?',
    fep_location_eu: 'Is the funeral being held in the European Economic Area (EEA) or Switzerland?',
    fep_location_hint: 'The funeral can also be held in the European Economic Area or Switzerland',
    fep_qualifying_benefits: 'Are you getting or waiting to hear about any of these benefits?',
    fep_qualifying_benefits_hint: 'They can include any benefits they are waiting to hear about',
    fep_responsibility: 'Are you paying for the funeral?',
    fep_residency: 'Did the person who died usually live in the UK?',
    final_step_continue: 'Continue',
    find_address: 'Find address',
    full_name: 'Full name',
    funeral_date: 'Do you know the funeral date?',
    funeral_date_when: 'Funeral date',
    have_bank_building_details_question: 'Does the caller have their bank account or building society details?',
    have_bank_building_details_question_executor: 'Does the caller have the bank or building society account details for the executor?',
    ...
    hospital_location: 'Name of hospital (optional)',
    ...
    none: `No, I don't get any of these benefits`,
    optional: 'Optional',
