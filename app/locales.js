const locales = {
  en_gb: {
    ...
    check_fep: 'Check Funeral Expenses Payment eligibility',
    ...
    complete_bsp_claim_body: 'Your BSP claim has been complete',
    complete_fep_claim_body: 'Your FEP claim has been complete',
    ...
    death_arrears_question: 'Is the caller who we would pay any benefits arrears to?',
    ...
    dependants: 'Does the caller get (or are they entitled to) Child Benefit?',
    ...
    ineligible_bsp_claim_body: 'You are not eligible for BSP',
